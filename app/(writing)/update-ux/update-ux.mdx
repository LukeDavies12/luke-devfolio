...
<video controls className='w-full'>
  <source src="http://localhost:3001/UpdateUXDemo.mov" type="video/mp4"/>
</video>
<br/>
...
By using Server Actions, reactive state management, and a clean UI, you can greatly improve the experience of updating forms in your Next.js app. **This pattern scales well, whether for blog posts, data entry, or complex datasets like in QB Logs.** Have questions or need help implementing this? Reach out to me on [Twitter](https://twitter.com/Luke_Davies09).